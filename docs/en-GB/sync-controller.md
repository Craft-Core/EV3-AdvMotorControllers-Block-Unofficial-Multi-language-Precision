...
Without synchronisation, even identical motors at the same commanded speed will drift apart over time due to mechanical differences. This block eliminates that drift.
